...
public class LoginScherm extends GridPane {
    ...
    public LoginScherm() {
        ...
        this.setPadding(new Insets(25, 25, 25, 25)); // Vrije ruimte rond de randen van de grid (boven, rechts, onder, links)
        ...
        Button btnCancel = new Button("Cancel"); // We aligneren btnCancel rechts
