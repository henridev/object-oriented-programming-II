...
public class VerplaatsingPerBusTramTest {
    ...
    public void maakVerplaatsingPerBusTram_lijnNrNegatief_maaktObject() {
    ...
    @Test
    public void setBus_waardeTrue_attribuutKrijgtWaarde() {
        vpbt2.setBus(true);
        Assertions.assertTrue(vpbt2.isBus());
    }


    @Test
    public void setStadslijn_waardeTrue_attribuutKrijgtWaarde() {
        vpbt2.setStadslijn(true);
        Assertions.assertTrue(vpbt2.isStadslijn());
    }
    ...
    public void toString_normaalGeval_geeftObjectInStringvorm() {
        Assertions.assertEquals("verplaatsing van Voskenslaan Gent naar Veldstraat Gent"
