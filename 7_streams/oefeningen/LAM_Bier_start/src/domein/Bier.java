...
public class Bier {
    ...
    public final void setBrouwerij(String brouwerij) {
        this.brouwerij = brouwerij;
    }
    ...
    public final void setAlcoholgehalte(double alcoholgehalte) {
        this.alcoholgehalte = alcoholgehalte;
    }
    ...
    public final void setBeoordeling(double beoordeling) {
        this.beoordeling = beoordeling;
    }
