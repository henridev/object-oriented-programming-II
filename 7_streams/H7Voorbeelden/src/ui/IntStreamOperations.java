...
public class IntStreamOperations
{
   public static void main(String[] args)
   {
      ...
      IntStream.of(values)
               .forEach(value -> System.out.printf("%d ", value)); // <1>
      System.out.println();
      ...
      System.out.printf("Average: %.2f%n", 
         IntStream.of(values).average().getAsDouble()); // <2>
